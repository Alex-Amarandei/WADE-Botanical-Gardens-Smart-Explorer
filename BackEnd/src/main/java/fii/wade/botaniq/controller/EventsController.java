...
public class EventsController {
    ...
    public ResponseEntity<Event> updateEvent(@PathVariable("eventId") String id, @RequestBody Event event){
        return new ResponseEntity<>(null, HttpStatus.OK);
    }
    ...
    public ResponseEntity<Event> getEventsByDate(@RequestBody String startDate, @RequestBody String endDate){
        return new ResponseEntity<>(null, HttpStatus.OK);
    }
}

...
public class GardensController extends BaseController<Garden, GardenService> {
  ...
  public ResponseEntity<Exhibition> getExhibitionByNameAndGardenId(
      @PathVariable("gardenId") String gardenId,
      @PathVariable("exhibitionName") String exhibitionName) {
    return new ResponseEntity<>(
        exhibitionService.getExhibitionById(gardenId, exhibitionName), HttpStatus.OK);
  }
}

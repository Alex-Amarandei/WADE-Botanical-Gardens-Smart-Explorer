            ...
            children: [
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image.network(
                    'https://images.nightcafe.studio/jobs/bjceiqpVf5bLDYr1kUDQ/bjceiqpVf5bLDYr1kUDQ--1--pnfpu.jpg?tr=w-1600,c-at_max',
                    width: MediaQuery.sizeOf(context).width * 1.0,
                    height: MediaQuery.sizeOf(context).height * 1.0,
                    fit: BoxFit.cover,
                  ),
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  .around(const SizedBox(height: 150.0)),
                            ),
                          ],
                        ),
                      ),
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            unawaited(
                              () async {
                                await launchURL(
                                    'https://github.com/Alex-Amarandei/WADE-Botanical-Gardens-Smart-Explorer');
                              }(),
                            );
                          },
                          text: 'Visit Us',
